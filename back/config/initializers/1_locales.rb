...
CL2_SUPPORTED_LOCALES = %i[en vi ar-SA en-GB en-CA nl-BE nl-NL fr-BE fr-FR de-DE
                           da-DK nb-NO es-ES es-CL pl-PL hu-HU kl-GL ro-RO pt-BR mi sr-Latn].freeze

I18n.available_locales = CL2_SUPPORTED_LOCALES + %i[vi nl fr de da nb es pl hu kl ro pt ar sr]
